...
public function addToCart($quantity, $id){
    ...
    if ($getPro) {
    	$msg = '<div class="alert alert-warning" role="alert">You already added Product to cart. Check out <a href="cart.php" class="alert-link">Cart</a></div>';
    	return $msg;
    }else{
    ...
    $query = "INSERT INTO tbl_cart(sId,productId,productName,price,quantity,image) VALUES('$sId','$productId','$productName','$price','$quantity','$image') ";
			...
			if ($inserted_row) {
				$msg = '<div class="alert alert-info" role="alert">Product added to cart. Check out <a href="cart.php" class="alert-link">Cart</a></div>';
    return $msg;
			} else{
